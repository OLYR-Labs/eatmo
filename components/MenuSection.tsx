  ...
  return (
    <section id="menu" className="py-16 md:py-24">
      <div className="container">
        ...
        <div
          className={`soft relative mt-6 overflow-hidden shadow-sm ${
            isRice ? "bg-black" : "bg-white"
          }`}
        >
          {isRice && categoryImage && (
            <div className="pointer-events-none absolute inset-0">
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-black/35 via-[#24103f]/65 to-[#24103f]/90" />
            </div>
          )}
